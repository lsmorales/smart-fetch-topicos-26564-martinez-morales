/** Pruebas unitarias para SmartFetch con Jest */

import { smartFetch } from '../src/index';
import { get, post, put, del } from '../src/metodos';
import { isSuccess, isError, getValue, getError, mapSuccess } from '../src/resultados-helpers';
...
describe('SmartFetch', () => {
    ...
    describe('Casos de éxito', () => {
        ...
        it('debería hacer una petición POST con cuerpo', async () => {
    ...
    describe('Manejo de errores', () => {
        it('debería manejar errores HTTP 4xx', async () => {
            ...
            if (isError(result)) {
                ...
                // Ahora TypeScript sabe que error es de tipo 'http'
    ...
    describe('Reintentos', () => {
        ...
        it('debería fallar cuando no queden más reintentos', async () => {
            for (let i = 0; i < 3; i++){
                mockFetch.mockResolvedValueOnce({
                    ok: false,
                    status: 500,
